...
class TestDescriptionGeneration(unittest.TestCase):
    ...
    def test_basic_git_commands(self):
        ...
        if not self.model_available:
            self.skipTest("CodeT5 model not available")
        ...
        for cmd in git_commands:
            with self.subTest(command=cmd):
                ...
                self.assertTrue(git_related, f"Description '{description}' should be git-related")
    ...
    def test_file_operations(self):
        ...
        for cmd in file_commands:
            with self.subTest(command=cmd):
                ...
                self.assertTrue(file_related, f"Description '{description}' should be file-related")
    ...
    def test_docker_commands(self):
        ...
        for cmd in docker_commands:
            with self.subTest(command=cmd):
                ...
                self.assertTrue(docker_related, f"Description '{description}' should be docker-related")
    ...
    def test_system_commands(self):
        ...
        for cmd in system_commands:
            with self.subTest(command=cmd):
                ...
                self.assertTrue(has_meaningful_content, f"Description '{description}' should have meaningful content")
    ...
    def test_programming_commands(self):
        ...
        for cmd in prog_commands:
            with self.subTest(command=cmd):
                ...
                self.assertGreater(len(description.strip()), 5)
    ...
    def test_description_length_limits(self):
        ...
        for max_len in [10, 20, 50]:
            with self.subTest(max_length=max_len):
                ...
                self.assertLessEqual(len(description.split()), max_len + 5)
    ...
    def test_rule_based_fallback(self):
        ...
        with patch('fuzzyshell.model_handler.DescriptionHandler._ensure_model_files') as mock_ensure:
            ...
            self.assertFalse(fallback_handler.use_t5_model)
            ...
            self.assertIn("List", description)
    ...
    def test_model_initialization_error_handling(self):
        ...
        with patch('os.path.exists') as mock_exists:
            ...
            with patch('fuzzyshell.model_handler.DescriptionHandler._download_file') as mock_download:
                ...
                self.assertFalse(handler.use_t5_model)
...
if __name__ == '__main__':
    print("🧪 Running comprehensive CodeT5 description generation tests...")
